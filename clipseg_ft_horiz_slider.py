...
def get_opts():
    ...
    parser.add_argument('--data_folder', type=str, default='/storage/chendudai/data/st_paul')  #'mosque' 'cathedral' 'synagogue'
...
for is_geo_occ in is_geo_occs:
    ...
    path_images = data_folder + '/dense/images/'
    save_images = True
    save_pickle = True
